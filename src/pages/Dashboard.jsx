...
// const chartData = dashboardData?.trend || [
// { week: "W1", exchanges: 0 },
// { week: "W2", exchanges: 0 },
// { week: "W3", exchanges: 0 }
// ];
...
// {dashboardData.completed_exchanges}
// </h2>
// <p className="text-green-600 mt-2">Live system data</p>
// </div>

// <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition">
// <p className="text-gray-500">Waste Diverted</p>
// <h2 className="text-5xl font-bold text-blue-700 mt-2">
// {dashboardData.total_landfill_diverted} kg
// </h2>
// <p className="text-green-600 mt-2">Circular reuse impact</p>
// </div>

// <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition">
// <p className="text-gray-500">CO₂ Emissions Saved</p>
// <h2 className="text-5xl font-bold text-green-600 mt-2">
// {dashboardData.total_co2_saved} kg
// </h2>
// <p className="text-green-600 mt-2">
// Equivalent sustainability benefit
// </p>
// </div>
...
// <li>⚡ Industrial reuse efficiency improving</li>
// <li>🌍 Circular economy network growing</li>
// <li>📈 Sustainability impact increasing</li>
// </ul>
// </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition">
            <p className="text-gray-500">Completed Exchanges</p>
            <h2 className="text-5xl font-bold text-purple-700 mt-2">
              {dashboardData.completed_exchanges}
            </h2>
            <p className="text-green-600 mt-2">Live system data</p>
